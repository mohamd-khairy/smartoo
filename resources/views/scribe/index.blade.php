...
<div class="bash-example">
    ...
    --form "image=@C:\Users\m.khairy\AppData\Local\Temp\php714F.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\m.khairy\AppData\Local\Temp\php714F.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>gender</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
                <label data-endpoint="PUTapi-v1-auth-profile" style="display: none">
            <input type="radio" name="contact_permission"
                   value="true"
                   data-endpoint="PUTapi-v1-auth-profile"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-v1-auth-profile" style="display: none">
...
<form id="form-POSTapi-v1-change-language" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-change-language');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-change-language"
                    onclick="cancelTryOut('POSTapi-v1-change-language');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-remote-settings" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-remote-settings');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-remote-settings"
                    onclick="cancelTryOut('GETapi-v1-remote-settings');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-remote-settings--country_code-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-remote-settings--country_code-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-remote-settings--country_code-"
                    onclick="cancelTryOut('GETapi-v1-remote-settings--country_code-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PUTapi-v1-remote-settings--country_code-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-v1-remote-settings--country_code-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-remote-settings--country_code-"
                    onclick="cancelTryOut('PUTapi-v1-remote-settings--country_code-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-v1-remote-settings--country_code-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-remote-settings--country_code-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-remote-settings--country_code-"
                    onclick="cancelTryOut('DELETEapi-v1-remote-settings--country_code-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<div class="bash-example">
    ...
    --form "subscription_id=architecto"\
    --form "image=@C:\Users\m.khairy\AppData\Local\Temp\php722B.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\m.khairy\AppData\Local\Temp\php722B.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --form "tracking_permission=1"\
    --form "subscription_id=architecto"\
    --form "image=@C:\Users\m.khairy\AppData\Local\Temp\php722C.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\m.khairy\AppData\Local\Temp\php722C.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>role</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
        ...
        &quot;data&quot;: [
            {
                ...
                &quot;duration_days&quot;: 40,
                &quot;status&quot;: &quot;inactive&quot;,
                &quot;created_at&quot;: &quot;2025-06-25T13:05:25.000000Z&quot;,
                &quot;updated_at&quot;: &quot;2025-06-25T13:06:22.000000Z&quot;
            }
        ],
        ...
        &quot;data&quot;: [
            {
                ...
                &quot;status&quot;: &quot;active&quot;,
                &quot;deleted_at&quot;: null,
                &quot;created_at&quot;: &quot;2025-06-25T13:07:29.000000Z&quot;,
                &quot;updated_at&quot;: &quot;2025-06-25T13:07:29.000000Z&quot;
            },
            {
                &quot;id&quot;: 3,
                &quot;user_id&quot;: 1,
                ...
                &quot;status&quot;: &quot;active&quot;,
                &quot;deleted_at&quot;: null,
                &quot;created_at&quot;: &quot;2025-06-25T13:07:32.000000Z&quot;,
                &quot;updated_at&quot;: &quot;2025-06-25T13:07:32.000000Z&quot;
            }
        ],
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://smartoo.test/api/v1/subscriptions/2" \
    --header "Authorization: Bearer 6g43cv8PD1aE5beadkZfhV6" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://smartoo.test/api/v1/subscriptions/2"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date before <code>end_date</code>. Example: <code>2021-07-19</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>start_date</code>. Example: <code>2051-07-19</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<form id="form-PUTapi-v1-subscriptions--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-v1-subscriptions--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-subscriptions--id-"
                    onclick="cancelTryOut('PUTapi-v1-subscriptions--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
